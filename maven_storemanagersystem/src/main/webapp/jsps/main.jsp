...
<html>
<head>
<link href="<c:url value='/css/maple.css'/>" type="text/css"
	rel=stylesheet></link>
</head>
		...
		<TBODY>
			<TR>
				...
				<TD><FONT style="FONT-SIZE: x-small" color=#fffaed><BR>
						<BR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<FONT
						color=#804060>当前用户：${loginuser.name } </font> </FONT></TD>
			</TR>
		</TBODY>
	</TABLE>
	<TABLE cellSpacing=0 cellPadding=0 width=984 height="120%" border=0
		background=<c:url value='/picture/bk3.jpg'/>>
		<TBODY>
			<TR>
							...
							<TR>
								<TD valign=middle align="center">
									<DIV id=shouhuo>
										...
										<s:a target="content" id="left1002" action="store_list"
											namespace="/">
											[仓库管理]</s:a>
										<BR />
										<s:a target="content" id="left1002" action="goods_list"
											namespace="/">
											[库存管理]
											</s:a>
										<BR /> <A id="left1003" target="content"
											href="<c:url value='/jsps/save/save.jsp'/>">[入库]</A> <BR />
										<a target="content" href="<c:url value='/jsps/out/out.jsp'/>">[出库]</a>
										<br />

										<s:a target="content" action="history_paginationList" namespace="/">[历史记录]</s:a>
				...
				<TD vAlign=top align=left width="88%"><iframe name="content"
						src="<c:url value='/picture/tyyw.bmp'/>" frameborder="0"
