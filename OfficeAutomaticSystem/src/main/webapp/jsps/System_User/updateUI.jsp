				...
				.blur(
						function() {
							...
							if (inputVal != "") {
								$
										.post(
												"${pageContext.request.contextPath}/user_findLoginName",
												{
													loginName : inputVal
												},
												function(data) {
													if (data == "1") {
														...
														$("#Msg")
																.html(
																		"<font color='green'>当前登陆名可以使用</font>");
														$("#save").removeAttr(
																"disabled");
													}
												});
			...
			<div class="ItemBlockBorder">
				<div class="ItemBlock">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						...
						<tr>
							<td>登录名</td>
							<td><s:textfield type="text" name="loginName"
									cssClass="InputStyle"></s:textfield> * （登录名要唯一） <span id="Msg"></span></td>
						</tr>
						<tr>
							<td>姓名</td>
							<td>
							<s:textfield type="text" name="name" csslass="InputStyle" >
							</s:textfield> *</td>
						</tr>
						<tr>
							<td>性别</td>
							<td>
								<s:radio type="RADIO" name="sex" id="male" list="#{'1':'男','0':'女'}"></s:radio>
						...
						<tr>
							<td>联系电话</td>
							<td>
							<s:textfield type="text" name="telephone" cssClass="InputStyle" ></s:textfield>
							</td>
						</tr>
						<tr>
							<td>E-mail</td>
							<td>
								<s:textfield type="text" name="email" cssClass="InputStyle"></s:textfield>
							</td>
						</tr>
						<tr>
							<td>备注</td>
					...
					<table cellpadding="0" cellspacing="0" class="mainForm">
						<tr>
							...
							<td><s:select name="roleIds" multiple="true" size="10"
									cssClass="SelectStyle" list="allRoles" listKey="id"
